...
Download the latest binary distribution from the Comprehensive R Archive Network.
...
Set the default location for the R installation to someplace you have write access, such as you Documents folder.
