...
```{r, eval=FALSE}
install.packages(c("raster", "rgdal", "rgeos", "dplyr", "dataRetrieval", "lattice",
                   "ggplot2", "colorspace", "viridis", "animation", "sfsmisc", "devtools",
                   "roxygen2", "knitr", "xtable"), repos = "https://cloud.r-project.org/")
```
...
Startup an RStudio session, it should look something like:
...
select the *Roots* tab, it should look something like:
...
Startup a *Git Bash* session, it should look something like:
