...
Be sure to enter the working directory as a character string (enclose it in quotes) and
specify the separator between folders using a forward slash (/) or double backslash (\\\\).
...
Type `ls()` to confirm that the function is in your working diretory.
Run the function passing what you think are approriate arguments.
Repeat the process by redefining the function, loading it into the R session, and using the function.
